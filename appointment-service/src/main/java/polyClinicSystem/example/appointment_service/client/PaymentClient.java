...
import polyClinicSystem.example.appointment_service.config.FeignConfig;
...
public interface PaymentClient {
    ...
    ResponseEntity<String> capturePayment(@PathVariable String paymentIntentId);

    @PostMapping("/api/payments/cancel-or-refund/{paymentIntentId}")
    ResponseEntity<String> cancelOrRefundPayment(@PathVariable String paymentIntentId);
