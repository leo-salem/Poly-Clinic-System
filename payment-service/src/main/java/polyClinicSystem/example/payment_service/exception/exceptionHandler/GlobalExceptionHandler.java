package polyClinicSystem.example.payment_service.exception.exceptionHandler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePaymentException(NotFoundException ex) {
